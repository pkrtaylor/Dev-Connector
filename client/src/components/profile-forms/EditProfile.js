...
// we need a useEffect to run get current profile so that it will actaully fecth the 
//data and send it down to the state
...
const EditProfile = ({
    ...
    // with useEffect it will keep reloading, so we want to include some bracketts
